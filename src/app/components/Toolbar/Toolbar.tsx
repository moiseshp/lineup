...
const Toolbar = () => {
  ...
  return (
    <>
      <div className="btm-nav lg:relative z-10 lg:justify-between lg:gap-2">
        <button className="lg:btn lg:basis-auto">
          <svg
        ...
        <button className="lg:btn lg:basis-auto lg:flex-row active">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
            fill="none"
          ...
          <span className="btm-nav-label text-xs lg:text-sm">Guardar</span>
        </button>
      ...
      <button className="btn  btn-primary flex-1 flex flex-col">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-6 w-6"
          fill="none"
